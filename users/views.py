...
def password_reset_view(request):
    if request.method == "POST":
        ...
        try:
            ...
            return Response(
                data={"message": "Code invalid!"}, status=status.HTTP_400_BAD_REQUEST
            )
        try:
        ...
        if user:
            ...
            try:
                reset_request = PasswordResets.objects.create(
                ...
                return Response(
                    data={
                        "message": "Code for reset your password sent to your email, check your email, please!"
                    },
                    status=status.HTTP_200_OK,
                )
            except Exception as e:
